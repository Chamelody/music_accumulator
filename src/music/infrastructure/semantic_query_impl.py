...
class SemanticQueryImpl(SemanticQuery):
    ...
    def __init__(
            self,
            create_semantic_query: CreateSemanticQuery = Provide[SemanticDependencyContainer.create_semantic_query],
            read_semantic_query: ReadSemanticQuery = Provide[SemanticDependencyContainer.read_semantic_query],
            delete_semantic_query: DeleteSemanticQuery = Provide[SemanticDependencyContainer.delete_semantic_query]
    ):
